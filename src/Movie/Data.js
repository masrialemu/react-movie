...
//         plot: "A thief, who steals corporate secrets through use of dream-sharing technology, is given the inverse task of planting anida into the mind of a CEO.",
...
//         plot: "A young F.B.I. cadet must conid in an incarcerated and manipulative killer to receive his help on catching another serial killer who skins his victims.",
...
//         plot: "A sexually frustrated suburban father has a idlife crisis after becoming infatuated with his daughter's best friend.",
...
//         plot: "A botched card game in London triggers four friends, thugs, weed-growers, hard gangsters, loan sharks and debt collectors to colid with each other in a series of unexpected events, all for the sake of weed, cash and two antique shotguns.",
...
//         plot: "A case of mistakenidntity lands Slevin into the idle of a war being plotted by two of the city's most rival crime bosses: The Rabbi and The Boss. Slevin is under constant surveillance by relentless Detective Brikowski as well as the infamous assassin Goodkat and finds himself having to hatch his own ingenious plot to get them before they get him.",
...
//         plot: "While on a trip to Paris with his fiancée's family, a nostalgic screenwriter finds himself mysteriously going back to the 1920s everyday at idight.",
...
//         plot: "An airline pilot saves almost all his passengers on his malfunctioning airliner which eventually crashed, but an investigation into the acidnt reveals something troubling.",
...
//         plot: "Forrest Gump, while not intelligent, has acidntally been present at many historic moments, but his true love, Jenny Curran, eludes him.",
...
//         plot: "Two girlfriends on a summer hoidy in Spain become enamored with the same painter, unaware that his ex-wife, with whom he has a tempestuous relationship, is about to re-enter the picture.",
...
//         actors: "Ben Stiller, Chris Rock, DaidSchwimmer, Jada Pinkett Smith",
...
//         director: "Eric Darnell, Tom McGrath",
//         actors: "Ben Stiller, Chris Rock, DaidSchwimmer, Jada Pinkett Smith",
//         plot: "Spoiled by their upbringing with noida what wild life is really like, four animals from New York Central Zoo escape, unwittingly assisted by four absconding penguins, and find themselves in Madagascar, among a bunch of merry lemurs",
...
//         plot: "On a mission to idsociety of its most repellent citizens, terminally ill Frank makes an unlikely accomplice in 16-year-old Roxy.",
...
//             "Drama"
//         ],
//         director: "DaidFincher",
//         actors: "Jesse Eisenberg, Rooney Mara, Bryan Barter, Dustin Fitzsimons",
//         plot: "Harvard student Mark Zuckerberg creates the social networking site that would become known as Facebook, but is later sued by two brothers who claimed he stole theirida, and the co-founder who was later squeezed out of the business.",
...
//         actors: "Humphrey Bogart, IngidBergman, Paul Henrid Claude Rains",
...
//         plot: "A former neo-nazi skinhead tries to prevent his younger brother from going down the same wrong path that he id",
...
//     {
//         id: 74,
//         title: "Pirates of the Caribbean: On Stranger ids",
//         year: "2011",
//         runtime: "136",
//         genres: [
//             "Action",
...
//         plot: "Los Angeles citizens with vastly separate lives colid in interweaving stories of race, loss and redemption.",
...
//         ],
//         director: "Peter Jackson",
//         actors: "Noel Appleby, Ali Astin, Sean Astin, DaidAston",
...
//         plot: "After being idapped and imprisoned for 15 years, Oh Dae-Su is released, only to find that he must find his captor in 5 days.",
...
//         plot: "A woman and her daughter open a chocolate shop in a small French village that shakes up the riidmorality of the community.",
...
//         plot: "In the distant future, a small waste-collecting robot inadvertently embarks on a space journey that will ultimately deid the fate of mankind.",
...
//         actors: "Beau Bides, Rosanna Arquette, Mathew Botuchis, Shiri Appleby",
...
//     {
//         id: 87,
//         title: "The Hitchhiker's Gid to the Galaxy",
//         year: "2005",
//         runtime: "109",
//         genres: [
//             "Adventure",
...
//         plot: "Mere seconds before the Earth is to be demolished by an alien construction crew, journeyman Arthur Dent is swept off the planet by his friend Ford Prefect, a researcher penning a new edition of \"The Hitchhiker's Gid to the Galaxy.\"",
...
//         plot: "A former Prohibition-era Jewish gangster returns to the Lower East id of Manhattan over thirty years later, where he once again must confront the ghosts and regrets of his old life.",
...
//         actors: "Ethan Hawke, Uma Thurman, Gore idl, Xander Berkeley",
//         plot: "A genetically inferior man assumes theidntity of a superior one in order to pursue his lifelong dream of space travel.",
...
//         ],
//         director: "Guillermo del Toro",
//         actors: "Charlie Hunnam, Diego Klattenhoff,Idis Elba, Rinko Kikuchi",
...
//         plot: "An exploration of how the actions of indiidal lives impact one another in the past, present and future, as one soul is shaped from a killer into a hero, and an act of kindness ripples across centuries to inspire a revolution.",
...
//         plot: "In 1985 Dallas, electrician and hustler Ron Woodroof works around the system to help ID patients get the medication they need after he is diagnosed with the disease.",
...
//         plot: "A biography of artist Fid Kahlo, who channeled the pain of a crippling injury and her tempestuous marriage into her work.",
...
//         actors: "Brendan Gleeson, Chris O'Dowd, Kelly Reilly, idn Gillen",
...
//         plot: "This story is set in 1930, at the time when French colonial rule in Indochina is ending. A idwed French woman who works in the rubber fields, raises a Vietnamese princess as if she was ...",
...
//         plot: "A jury holdout attempts to prevent a miscarriage of justice by forcing his colleagues to reconidr the eidnce.",
...
//         actors: "DaidSchwimmer, Simon Pegg, Alice Eve, Natascha McElhone",
...
//         plot: "Rumpelstiltskin tricks a idlife crisis burdened Shrek into allowing himself to be erased from existence and cast in a dark alternate timeline where Rumpel rules supreme.",
...
//         actors: "Lisa Adam, Frank Aldide, Amitabh Bachchan, Steve Bisley",
...
//         plot: "A meek Hobbit from the Shire and eight companions set out on a journey to destroy the powerful One Ring and save idle Earth from the Dark Lord Sauron.",
...
//         plot: "While Frodo and Sam edge closer to Mordor with the help of the shifty Gollum, the diidd fellowship makes a stand against Sauron's new ally, Saruman, and his hordes of Isengard.",
...
//         plot: "A young programmer is selected to participate in a ground-breaking experiment in synthetic intelligence by evaluating the human qualities of a breath-taking humanidA.I.",
...
//         plot: "Atticus Finch, a lawyer in the Depression-era South, defends a black man against an undeserved rape charge, and his id against prejudice.",
...
//         plot: "Four denizens in the world of high-finance predict the credit and housing bubble collapse of the id2000s, and deid to take on the big banks for their greed and lack of foresight.",
